...
let Video = ({time, channel, views, title, verified, id, children, dispatch, edit}) =>{
    console.log('Rendering Video')

    return(
    <>
        <div className="video-wrapper text-white d-inline-block me-4 position-relative">
            <h6 className="position-absolute top-0 end-0 border rounded-circle bg-white p-1" role='button' onClick={()=>dispatch({type: 'DELETE', payload: id})}>❌</h6>
